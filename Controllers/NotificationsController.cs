...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notification.Include(n => n.NotificationType).Include(n => n.Project).Include(n => n.Sender).Include(n => n.Ticket);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectId,TicketId,Title,Message,Created,SenderId,RecipentId,NotificationTypeId,HasBeenViewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProjectId,TicketId,Title,Message,Created,SenderId,RecipentId,NotificationTypeId,HasBeenViewed")] Notification notification)
        {
